...
function showInstallBanner() {
  ...
  banner.innerHTML = `
    ...
    ">
      <img src="${BASE}/logo.png" style="width:36px;height:36px;border-radius:50%;border:1px solid #c9a227;">
  ...
  banner.innerHTML = `
    ...
    ">
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
        <img src="${BASE}/logo.png" style="width:40px;height:40px;border-radius:50%;border:1.5px solid #c9a227;">
        <div>
